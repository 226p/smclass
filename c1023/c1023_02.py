...
## csv 파일저장 - 리스트 바로 저장
## csv 파일 저장 시 한글인코딩(한글안깨지게) : utf-8-sig
with open("c1023/a.csv","w",encoding="utf-8-sig",newline="") as f:  # csv는 자동줄바꿈 해줘서 newline = ""해주면 줄바꿈 없이 들어감
  writer = csv.writer(f)
  writer.writerow(st_list)   # 파일에 리스트 저장
