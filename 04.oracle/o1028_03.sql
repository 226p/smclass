...
select EMP_NAME from EMPLOYEES;  -- 대소문자 구별안함
select emp_name from employees;

select emp_name from employees where emp_name = 'pat Fay'; -- 정보에 대한 대소문자는 구별해야 함

select * from employees;

select employee_id,emp_name,phone_number,hire_date from employees;

-- employee_id,emp_name,job_id 출력하되 job_id 'SH_CLERK' 사람만 출력
