...
def stu_print(*data):   ### 2-1.출력함수 선언
  ### 출력부분
  print("\t\t\t[ 학생성적 출력 ]")
  print(f"\t\t\t\t\t\t\t\t[ 개수 : {len(rows)} ]")
  for s in s_title:
